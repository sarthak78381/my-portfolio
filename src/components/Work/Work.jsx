...
function Work({wheelScroll}) {
    ...
    useEffect(() => {
        ...
        let newRange = 1 - 0;
        let op = ((wheelScroll - 0) * newRange / oldRange) - 0.1;
    ...
    return (
        <section id="Work" style={{display: wheelScroll < window.innerHeight*2 && wheelScroll >= (window.innerHeight - window.innerHeight/3) ? "" : "none",opacity:"0"}} ref={WorkSection}>
